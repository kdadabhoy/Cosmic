// wo08_tint_quad.glsl — WO-08 F-2D fixture: the batch quad shader (Texture.glsl
// contract) multiplied by a uniform tint. Lets a Material-drawn quad be told
// apart from a default-shader quad by colour alone (R02 material/shader
// transitions). Not an engine shader; loaded by CosmicRenderTests only.
#type vertex
#version 450 core
...
// Literal-index fetch, same scheme as Texture.glsl (KI-82).
...
void main()
{
	color = SampleSlot(v_TexIndex, v_TexCoord * v_TilingFactor) * v_Color * u_Tint;
}
