...
// TestFirmwareTemplates.h — (merged from SF_TelemTest)
// ============================================================================
...
//
// Wrapped in Workspace::TestFw so its FwKissModule()/FwReplaceAll() helpers do
// not collide with the main FirmwareTemplates.h (BuildMainFirmware etc.), which
// lives in Workspace directly and is included by TelemHub.cpp.
// ============================================================================
