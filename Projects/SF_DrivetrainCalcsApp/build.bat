...
echo ======================================================
echo            Cosmic Engine - SF_DrivetrainCalcsApp
echo ======================================================
...
echo [STAGE 2] Building SF_DrivetrainCalcsApp.dll...
...
echo.
echo SUCCESS: SF_DrivetrainCalcsApp.dll built and assets synced! (%BUILD_CONFIG%)
cd ..
ENDLOCAL
