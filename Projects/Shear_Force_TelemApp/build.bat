...
echo ======================================================
echo            Cosmic Engine - Shear_Force_TelemApp
echo ======================================================
...
echo [STAGE 2] Building Shear_Force_TelemApp.dll...
...
echo.
echo SUCCESS: Shear_Force_TelemApp.dll built and assets synced! (%BUILD_CONFIG%)
cd ..
ENDLOCAL
