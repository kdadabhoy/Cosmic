...
| [`plans/`](plans/00-MASTER-ROADMAP.md) | Live work plans. Start at [`00-MASTER-ROADMAP.md`](plans/00-MASTER-ROADMAP.md) for phase order; each numbered doc holds PR-sized work orders with acceptance checks. `plans/archive/` keeps completed plans as records. |
