# API Reference — Frame Pipeline, 3D half (EnvironmentMap, ShadowMap, CoverageCapture)
...
**Scope (headers are the truth; all deleted from `main` by AP-05):** `renderer/EnvironmentMap.h`, `renderer/ShadowMap.h`,
