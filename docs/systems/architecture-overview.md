...
**API Reference:** [../reference/README.md](../reference/README.md) · **Guide:** root README §1
...
2. **Mental model** — diagram **DG-1** (module block diagram) + **DG-2** (core class diagram). <!-- TODO(D25) -->
