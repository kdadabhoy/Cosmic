...
| UX-04 | G2 | `Cosmic-SDK-<ver>-win64.zip`, `Starforge-Setup-<ver>.exe`, release workflow, GLFW install leak, KI-63 | 1, 3 | wave 1 landed | SD01–SD04, K02-bak | [UX-04.md](work-orders/UX-04.md) |
...
| UX-D1 | G3 | Guides tier, `docs/guide/` → `docs/developer/`, eight guides with captured pictures | 1, 2, 9, 10, 12, 13, 15, 18, 21 | wave 2 landed | DOC01, DOC03, DG01, DG02 (executable) | [UX-D1.md](work-orders/UX-D1.md) |
...
- **UX-D1** — eight guides with every image in the manifest and produced by the declared method; the
  rename landed with the link checker strict 0; DG02 executable (driver + wrapper + manifest).
