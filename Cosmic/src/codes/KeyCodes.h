...
/**
 * General Description:
 * KeyCodes.h defines the engine's internal representation of keyboard hardware.
 * These definitions allow the engine to remain agnostic of the underlying
 * platform API (GLFW, Win32, etc.).
 *
 * Usage:
 * Use these constants when checking for input state via Cosmic::Input or
 * when processing Cosmic::KeyEvent objects.
 */
