...
// COSMIC LOCAL PATCH (2026-07-11, see VENDOR-NOTES.md): imgui 1.92.x defines
// operator*(float, ImVec2) itself (imgui.h math operators are always-on now),
// so only provide it for older imgui versions.
